      ...
      try {
        await dispatch(
          updateCategory({
            ...
            categoryData: { name: editedCategoryName },
          })
        ).unwrap();
  ...
  const handleDeleteCategory = async (id) => {
    if (window.confirm("Are you sure you want to delete this category?")) {
      try {
        ...
        toast.error(
          err.message ||
            "Failed to delete category. Check if it has linked expenses."
        );
      }
    }
  };
            ...
            {categories.map((category) => (
              ...
              >
                {editingCategory && editingCategory._id === category._id ? (
                  ...
                  <>
                    <span className="text-lg text-gray-800 flex items-center flex-wrap">
                      {" "}
